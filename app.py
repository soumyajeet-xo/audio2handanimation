...
SAMPLE_RATE = 16000
def custom_load_audio(byte_data: bytes, sr=SAMPLE_RATE): #converts byte data to what whisper can use ( https://github.com/openai/whisper/blob/main/whisper/audio.py)
    cmd = [
        "ffmpeg",
        "-nostdin",
        "-threads", "0",
